...
Плагин A.I.R ZCode Plugins версии 0.1.23 добавляет русский язык и перевод интерфейса в обычный ZCode Desktop 3.6.5 на Windows 10 и Windows 11.
...
Поддерживаются только Windows 10, Windows 11 и ZCode Desktop 3.6.5.
