...
На Windows версия 0.1.14 работает внутри обычного ZCode и не меняет файлы приложения. После первой установки один раз открой новую задачу, затем выбери **Settings > General > Language > Русский** или **Профиль > Язык > Русский**. Перезапуск ZCode не нужен.
