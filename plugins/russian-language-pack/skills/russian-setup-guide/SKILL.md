...
На Windows версия 0.1.19 работает внутри обычного ZCode Desktop 3.4.2 и не меняет файлы приложения. После первой установки один раз открой новую задачу, затем выбери **Settings > General > Language > Русский** или **Профиль > Язык > Русский**. Перезапуск ZCode не нужен.
