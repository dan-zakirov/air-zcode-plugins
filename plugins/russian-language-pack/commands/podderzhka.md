...
- поддержка: Windows 10/11, ZCode Desktop 3.5.3;
...
- версия 0.1.21 работает в памяти обычного ZCode на Windows, не изменяет `app.asar` и автоматически восстанавливается после перезапуска;
