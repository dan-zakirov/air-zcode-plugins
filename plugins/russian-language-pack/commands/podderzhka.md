...
- поддержка: Windows 10/11, ZCode Desktop 3.4.2;
...
- версия 0.1.19 работает в памяти обычного ZCode на Windows, не изменяет `app.asar` и автоматически восстанавливается после перезапуска;
