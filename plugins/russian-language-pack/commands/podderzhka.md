...
- поддержка: Windows 10/11, ZCode Desktop 3.6.5;
...
- версия 0.1.23 работает в памяти обычного ZCode на Windows, не изменяет `app.asar` и автоматически восстанавливается после перезапуска;
